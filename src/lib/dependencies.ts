...
const ALWAYS_SKIP_TASK_NAMES: ReadonlySet<string> = new Set([
  ...
  // XP milestones — user judgement: bulk-XP grinds aren't worth a roll slot
  // in the final weeks of the league. Only listing the unfinished ones;
  // completed milestones already can't roll.
  'Obtain 100 Million XP in a combat skill',
  'Obtain 100 Million XP in any non-combat skill',
  ...
  'Obtain 25 Million Thieving XP',
  'Obtain 25 Million Woodcutting XP',
  'Obtain 25 Million XP in 5 non-combat skills',
  'Obtain 35 Million Agility XP',
  'Obtain 35 Million Construction XP',
  'Obtain 35 Million Cooking XP',
  'Obtain 35 Million Crafting XP',
  'Obtain 35 Million Farming XP',
  'Obtain 35 Million Firemaking XP',
  'Obtain 35 Million Fishing XP',
  'Obtain 35 Million Fletching XP',
  'Obtain 35 Million Herblore XP',
  'Obtain 35 Million Hunter XP',
  'Obtain 35 Million Mining XP',
  'Obtain 35 Million Prayer XP',
  'Obtain 35 Million Runecraft XP',
  'Obtain 35 Million Slayer XP',
  'Obtain 35 Million Smithing XP',
  'Obtain 35 Million Thieving XP',
  'Obtain 35 Million Woodcutting XP',
  'Obtain 35 Million XP in 3 non-combat skills',
  'Obtain 50 Million Agility XP',
  'Obtain 50 Million Attack XP',
  'Obtain 50 Million Construction XP',
  'Obtain 50 Million Cooking XP',
  'Obtain 50 Million Crafting XP',
  'Obtain 50 Million Defence XP',
  'Obtain 50 Million Farming XP',
  'Obtain 50 Million Firemaking XP',
  'Obtain 50 Million Fishing XP',
  'Obtain 50 Million Fletching XP',
  'Obtain 50 Million Herblore XP',
  'Obtain 50 Million Hunter XP',
  'Obtain 50 Million Mining XP',
  'Obtain 50 Million Prayer XP',
  'Obtain 50 Million Ranged XP',
  'Obtain 50 Million Runecraft XP',
  'Obtain 50 Million Slayer XP',
  'Obtain 50 Million Smithing XP',
  'Obtain 50 Million Strength XP',
  'Obtain 50 Million Thieving XP',
  'Obtain 50 Million Woodcutting XP',
  'Obtain 200 Million XP in a combat skill',
  'Obtain 200 Million XP in any non-combat skill',
  'Obtain 50 Million XP in 3 non-combat skills',
  // Mastering Mixology — minigame grind the user finds boring.
  'Equip a piece of Alchemists outfit',
  'Equip full Alchemists outfit',
  'Purchase the Reagents Pouch',
  'Purchase the Chugging Barrel',
  // Full Graceful — too grindy for the payoff.
  'Equip a set of recoloured Graceful',
  'Equip a Full Graceful Outfit',
  // Forestry — boring. `Equip a two-handed Axe` is the Felling-axe task
  // (description: "Equip a Felling axe"). Chompy hat is technically Big
  // Chompy Bird Hunting but bucketed with Forestry per user preference.
  'Equip a two-handed Axe',
